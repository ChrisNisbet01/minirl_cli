...
static bool
space_handler(minirl_st * const minirl, char const * const key, void * const user_ctx)
{
...
static bool
ctrl_right_handler(minirl_st * const minirl, char const * const key, void * const user_ctx)
{
	return true;
}

static bool
ctrl_left_handler(minirl_st * const minirl, char const * const key, void * const user_ctx)
{
	return true;
}
